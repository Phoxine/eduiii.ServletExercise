...
@WebServlet("/ch05_02/ReadParameters.do")
public class ReadParametersServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
       ...
       if (errorMessage.size() != 0){ // 表示有錯誤
    	    ...
    	    RequestDispatcher rd = request.getRequestDispatcher("/ch05_02/InputData.jsp");
    	    rd.forward(request, response);
    	    return;
       }
       RequestDispatcher rd = request.getRequestDispatcher("/ch05_02/InputDataSuccess.jsp");
       rd.forward(request, response);
	   return;
	}
}